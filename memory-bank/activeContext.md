...
- Task 9 (Source-of-Truth Discovery) is completed and verified (145 tests passing).
- Moving forward in Sprint 3: Correctness Agent & Baseline Security.

## Active Focus
- **Task 10 — Rewrite Correctness Rubric/Methodology**: Author correctness-only review criteria, capping no-spec findings at `medium`.

## Next Steps
1. Create/refactor `src/gdg_yorku_submission/correctness/methodology.md`.
2. Implement unit tests in `tests/test_correctness_methodology.py`.
3. Verify via pytest.
