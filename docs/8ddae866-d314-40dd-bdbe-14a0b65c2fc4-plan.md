...
- **Files:** `README.md`, `NOTICE.md`, `.gitignore`, `pyproject.toml`, `src/crossfire_review/__init__.py`, `tests/`, `scripts/check_commit_window.py`, `tests/test_commit_window.py`.
...
- **Files:** `src/crossfire_review/schemas.py`, `src/crossfire_review/severity.py`, `tests/test_schemas.py`, `tests/test_severity.py`.
...
- **Files:** `src/crossfire_review/finding_ids.py`, `tests/test_finding_ids.py`.
...
- **Files:** `src/crossfire_review/app.py`, `src/crossfire_review/orchestrator.py`, `src/crossfire_review/orchestration/__init__.py`, `tests/test_api_skeleton.py`, `tests/test_orchestrator_conformance.py`.
...
- **Files:** `src/crossfire_review/ingest.py`, `tests/test_ingest.py`, `tests/fixtures/`.
...
- **Files:** `src/crossfire_review/corpus.py`, `tests/test_corpus.py`, `README.md`.
...
- **Files:** `src/crossfire_review/preflight/secrets.py`, `src/crossfire_review/preflight/redaction.py`, `tests/test_secret_preflight.py`.
...
- **Files:** `src/crossfire_review/prompts/evidence_plane.py`, `tests/test_evidence_plane.py`.
...
- **Files:** `src/crossfire_review/correctness/sot.py`, `tests/test_sot_discovery.py`.
...
- **Files:** `src/crossfire_review/correctness/methodology.md`, `tests/test_correctness_methodology.py`.
...
- **Files:** `src/crossfire_review/security/deterministic.py`, `tests/test_security_deterministic.py`.
...
- **Files:** `src/crossfire_review/correctness/agent.py`, `src/crossfire_review/llm/gemini.py`, `src/crossfire_review/budget.py`, `tests/test_correctness_agent.py`.
...
- **Files:** `src/crossfire_review/coordinator/agent.py`, `src/crossfire_review/coordinator/prompts.py`, `tests/test_coordinator_agent.py`.
...
- **Files:** `src/crossfire_review/coordinator/validator.py`, `tests/test_report_validator.py`.
...
- **Files:** `src/crossfire_review/orchestrator.py`, `src/crossfire_review/coordinator/terminal_report.py`, `tests/test_report_regeneration.py`.
...
- **Files:** `src/crossfire_review/static/{index.html,app.js,styles.css}`, `src/crossfire_review/app.py`.
...
- **Test first:** `python -m crossfire_review.demo_hooks drop-high samples/driftstore.zip` runs the validator against a deliberately corrupted in-memory report and prints validator errors; a test asserts the module is **not** imported by any FastAPI route and not reachable over HTTP.
- **Files:** `src/crossfire_review/demo_hooks.py` (clearly non-production), `tests/test_validator_demo_hook.py`, `docs/demo-script.md`.
...
- **Files:** `src/crossfire_review/security/debate_schema.py`, `tests/test_debate_schema.py`.
...
- **Files:** `src/crossfire_review/security/debate.py`, `src/crossfire_review/security/stop_condition.py`, `tests/test_debate_loop.py`.
...
- **Files:** `src/crossfire_review/security/agent.py`, `src/crossfire_review/llm/claude.py`, `tests/test_security_agent.py`.
...
- **Files:** `src/crossfire_review/blast_radius/{agent.py,orbit_client.py}`, `tests/test_blast_radius.py`.
